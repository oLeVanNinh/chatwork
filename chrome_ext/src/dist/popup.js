...
window.onload = async function() {
  ...
  let secret = await (0,_cookie_sync_js__WEBPACK_IMPORTED_MODULE_0__/* .get_value */ .uE)("secret");
  if (!secret) {
    $("#url").hide();
  }
  else {
  ...
  $("#add-secret").click(async function() {
    ...
    if (is_edit) {
      ...
      if (secret) {
        await (0,_cookie_sync_js__WEBPACK_IMPORTED_MODULE_0__/* .set_value */ .Vj)("secret", secret);
        set_display_secret();
      }
    }
  });
...
function set_display_secret() {
  ;(0,_cookie_sync_js__WEBPACK_IMPORTED_MODULE_0__/* .get_value */ .uE)("secret").then((secret) => {
